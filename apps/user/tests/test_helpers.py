...
class UserHelperTest(TestCase):
    ...
    def test_validate_unique_email_existing(self):
        ...
        self.assertEqual(
            error.message_dict["email"][0], "error.email-already-used-by-other"
        )
    ...
    def test_validate_unique_cpf_existing(self):
        ...
        self.assertEqual(
            error.message_dict["cpf"][0], "error.cpf-already-used-by-other"
        )
    ...
    def test_validate_unique_mobile_phone_existing(self):
        ...
        self.assertEqual(
            ...
            "error.mobile-phone-already-used-by-other",
        )
    ...
    def test_validate_cpf_valid(self):
        valid_cpfs = ["52998224725", "74119455919", "87373145120"]
    ...
    def test_validate_cpf_invalid(self):
        ...
        for cpf_value in invalid_cpfs:
            ...
            error = context.exception
            self.assertEqual(error.message, "error.invalid-cpf")
