# Generated by Django 6.0.1 on 2026-01-25 19:24
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "image",
                    apps.shop.fields.ProductImageField(
                        blank=True,
                        crop=["middle", "center"],
                        force_format=None,
                        keep_meta=True,
            ...
            options={
                "verbose_name": "model.shop-product.name",
                "verbose_name_plural": "model.shop-product.name.plural",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "file",
                    apps.shop.fields.ProductFileField(
                        max_length=255,
                        upload_to="files/product/%Y/%m/%d",
                        verbose_name="model.field.file",
                    ),
                ),
                (
                    "file_type",
                    models.CharField(
                        ...
                        max_length=50,
                        null=True,
                        verbose_name="model.field.file-type",
                    ),
                ),
                (
                    "file_size",
                    models.PositiveIntegerField(
                        ...
                        default=0,
                        null=True,
                        verbose_name="model.field.file-size",
                    ),
                ),
                (
                    "active",
                ...
                (
                    ...
                    models.ForeignKey(
                        ...
                        related_name="files",
                        to="shop.product",
                        verbose_name="model.field.product",
                    ),
                ),
            ],
            options={
                "verbose_name": "model.shop-product-file.name",
                "verbose_name_plural": "model.shop-product-file.name.plural",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "token",
                    models.CharField(
                        default=pyaa.helpers.string.StringHelper.generate_product_purchase_token,
                        editable=False,
                        max_length=255,
                        unique=True,
                        verbose_name="model.field.token",
                ...
                (
                    ...
                    models.CharField(
                        choices=[
                            ("initial", "enum.shop-product-purchase-status.initial"),
                            ("analysis", "enum.shop-product-purchase-status.analysis"),
                            ("approved", "enum.shop-product-purchase-status.approved"),
                            ("canceled", "enum.shop-product-purchase-status.canceled"),
                            ("failed", "enum.shop-product-purchase-status.failed"),
                            (
                                "charged-back",
                                "enum.shop-product-purchase-status.charged-back",
                            ),
                            ("rejected", "enum.shop-product-purchase-status.rejected"),
                            ("refunded", "enum.shop-product-purchase-status.refunded"),
                        ],
                        default="initial",
                        max_length=255,
                        verbose_name="model.field.status",
            ...
            options={
                "verbose_name": "model.product-purchase.name",
                "verbose_name_plural": "model.product-purchase.name.plural",
        ...
        migrations.CreateModel(
                ...
                (
                    ...
                    models.CharField(
                        ...
                        choices=[
                            ...
                            (
                                "product-purchase",
                                "enum.shop-object-type.product-purchase",
                            ),
            ...
            options={
                ...
                "indexes": [
                    ...
                    models.Index(
                        fields=["is_refund"], name="shop_credit_log_is_refund"
                    ),
                    models.Index(
        ...
        migrations.AddIndex(
            model_name="plan",
            index=models.Index(fields=["token"], name="shop_plan_token"),
        ),
        migrations.AddIndex(
            model_name="plan",
        ...
        migrations.AddIndex(
            ...
            index=models.Index(fields=["token"], name="shop_credit_purchase_token"),
        ),
        migrations.AddIndex(
            model_name="creditpurchase",
            index=models.Index(fields=["status"], name="shop_credit_purchase_status"),
        ),
        migrations.AddIndex(
            model_name="creditpurchase",
            index=models.Index(
                fields=["invoice_generated"], name="shop_credit_purchase_inv_gen"
            ),
        ),
        migrations.AddIndex(
            model_name="product",
            index=models.Index(fields=["name"], name="shop_product_name"),
        ),
        migrations.AddIndex(
            model_name="product",
            index=models.Index(fields=["token"], name="shop_product_token"),
        ),
        migrations.AddIndex(
            model_name="product",
            index=models.Index(fields=["currency"], name="shop_product_currency"),
        ),
        migrations.AddIndex(
            model_name="product",
            index=models.Index(fields=["active"], name="shop_product_active"),
        ),
        migrations.AddIndex(
            model_name="product",
            index=models.Index(fields=["slug"], name="shop_product_slug"),
        ),
        migrations.AddIndex(
            model_name="productfile",
            index=models.Index(fields=["product"], name="shop_product_file_product"),
        ),
        migrations.AddIndex(
            model_name="productfile",
            index=models.Index(
                fields=["file_type"], name="shop_product_file_file_type"
            ),
        ),
        migrations.AddIndex(
            model_name="productfile",
            index=models.Index(fields=["active"], name="shop_product_file_active"),
        ),
        migrations.AddIndex(
            model_name="productpurchase",
            index=models.Index(fields=["token"], name="shop_product_purchase_token"),
        ),
        migrations.AddIndex(
            model_name="productpurchase",
            index=models.Index(fields=["status"], name="shop_product_purchase_status"),
        ),
        migrations.AddIndex(
            model_name="productpurchase",
            index=models.Index(
                fields=["invoice_generated"], name="shop_product_purchase_inv_gen"
            ),
        ),
        migrations.AddIndex(
